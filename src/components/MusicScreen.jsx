    ...
    <>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center">
          <div className="bg-dark w-80 p-6 rounded-md text-center border-2 border-burgundy">
            <h2 className="text-2xl font-semibold mb-4 text-[#f0e5d8]">
              ¿Deseas ingresar con música?
            </h2>
            <div className="flex flex-col gap-4">
              <button
                className="bg-gold text-dark py-2 rounded hover:bg-[#a89968] transition font-semibold"
                onClick={() => handleChoice("withMusic")}
              >
                Con música
              </button>
              <button
                className="bg-burgundy text-[#f0e5d8] py-2 rounded hover:bg-[#8B3A3F] transition font-semibold"
